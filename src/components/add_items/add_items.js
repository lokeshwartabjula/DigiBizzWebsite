  ...
  const handleFileChange = (event) => {
    ...
    image.onload = function() {
      if (image.width !== 400 || image.height !== 500) {
        setErrorMessage('Invalid image dimensions. Please choose an image with dimensions 400x500 pixels.');
        event.target.value = '';
        return;
      }
        ...
        <div class="mx-8">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-3">
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <div className="flex rounded-md ring-1 ring-gray-300">
                  <select id="countries" class="block flex-1 border-0 bg-transparent py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
            ...
            <div className="sm:col-span-3">
              ...
              />
              <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">JPEG, PNG, JPG (SIZE = 400x500px).</p>
